 ...
 * @returns {Promise<FileInfoResult>} Please note that prettier.getFileInfo()
 *     expects opts.plugins to be an array of paths, not an object. A
 *     transformation from this array to an object is automatically done
